...
openBusqueda(){
  ...
  renderDataTable() {
    ...
    this.api.getApiTabla('/tipoPago').subscribe(x => {
  ...
  const dialogo2=this.dialog.open(AddCajasComponent, {
    width: '400px',
    enterAnimationDuration,
    exitAnimationDuration,
    data: {
  ...
  openDialog(enterAnimationDuration: string, exitAnimationDuration: string): void {
    const dialogo1 =this.dialog.open(AddCajasComponent, {
      width: '400px',
      enterAnimationDuration,
      exitAnimationDuration,
      data: {
